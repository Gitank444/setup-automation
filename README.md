...
- Keep the `config` mapping updated when new tools are added
- Prefer `winget` for Windows system tool installation when available
- Use targeted tests for resolver logic and installer selection
- Keep `README.md` and architecture docs in sync with implementation changes
